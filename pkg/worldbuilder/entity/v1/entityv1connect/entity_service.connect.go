...
import (
	...
	v1 "github.com/ssargent/public-apis/pkg/worldbuilder/entity/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	// CreateEntity RPC.
	EntityServiceCreateEntityProcedure = "/worldbuilder.entity.v1.EntityService/CreateEntity"
)
...
// CreateEntity calls worldbuilder.entity.v1.EntityService.CreateEntity.
func (c *entityServiceClient) CreateEntity(ctx context.Context, req *connect_go.Request[v1.CreateEntityRequest]) (*connect_go.Response[v1.CreateEntityResponse], error) {
...
func NewEntityServiceHandler(svc EntityServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	entityServiceCreateEntityHandler := connect_go.NewUnaryHandler(
...
func (UnimplementedEntityServiceHandler) CreateEntity(context.Context, *connect_go.Request[v1.CreateEntityRequest]) (*connect_go.Response[v1.CreateEntityResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("worldbuilder.entity.v1.EntityService.CreateEntity is not implemented"))
}
