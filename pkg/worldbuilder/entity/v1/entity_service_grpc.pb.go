...
const (
	...
	EntityService_CreateEntity_FullMethodName = "/worldbuilder.entity.v1.EntityService/CreateEntity"
)
...
func (c *entityServiceClient) CreateType(ctx context.Context, in *CreateTypeRequest, opts ...grpc.CallOption) (*CreateTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, EntityService_CreateType_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
